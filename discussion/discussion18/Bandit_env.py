...
class Interactive_UCB_Algorithm:
	...
	def recalculate_bounds(self):
		t=self.bandit_env.t
		arm,self.upper_confidence_bounds=self.alg(t,self.bandit_env.standard_deviations,self.bandit_env.times_pulled,self.bandit_env.rewards)
		return
...
class Interactive_TS_Algorithm:
	...
	def recalculate_bounds(self,start=0):
		...
		if start:
			...
			t=self.bandit_env.t
		var=self.bandit_env.standard_deviations**2
